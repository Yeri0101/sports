...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, class: "mb-3" do |b|
    ...
    b.use :hint, wrap_with: { class: "form-text text-secondary", tag: :small }
  end
  ...
  config.wrappers :vertical_boolean, tag: "fieldset", class: "mb-3" do |b|
    ...
    b.wrapper :form_check_wrapper, class: "form-check" do |bb|
      ...
      bb.use :hint, wrap_with: { class: "form-text text-secondary", tag: :small }
    end
  end
  ...
  config.wrappers :vertical_multi_select, class: "mb-3" do |b|
    ...
    b.use :label, class: "form-label"
    b.wrapper class:
                "align-items-center d-flex flex-row justify-content-between" do |ba|
      ba.use :input,
  ...
  config.wrappers :horizontal_form, class: "row mb-3" do |b|
    ...
    b.wrapper :grid_wrapper, class: "col-sm-9" do |ba|
      ...
      ba.use :hint, wrap_with: { class: "form-text text-secondary", tag: :small }
    end
  end
  ...
  config.wrappers :inline_form, class: "col-12" do |b|
    ...
    b.optional :hint, wrap_with: { class: "form-text text-secondary", tag: :small }
  end
  ...
  config.wrappers :inline_boolean, class: "col-12" do |b|
    ...
    b.wrapper :form_check_wrapper, class: "form-check" do |bb|
      ...
      bb.optional :hint, wrap_with: { class: "form-text text-secondary", tag: :small }
    end
  end
